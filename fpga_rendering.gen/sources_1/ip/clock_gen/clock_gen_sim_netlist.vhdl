...
end clock_gen_clk_wiz;

architecture STRUCTURE of clock_gen_clk_wiz is
  signal clk_100mhz_clock_gen : STD_LOGIC;
...
clkin1_ibufg: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_100mhz,
      O => clk_100mhz_clock_gen
    );
clkout1_buf: unisim.vcomponents.BUFG
     port map (
      I => clk_25mhz_clock_gen,
      O => clk_25mhz
    );
plle2_adv_inst: unisim.vcomponents.PLLE2_ADV
    generic map(
      ...
      CLKIN1 => clk_100mhz_clock_gen,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKOUT0 => clk_25mhz_clock_gen,
...
entity clock_gen is
  ...
  attribute NotValidForBitStream of clock_gen : entity is true;
end clock_gen;

architecture STRUCTURE of clock_gen is
begin
inst: entity work.clock_gen_clk_wiz
     port map (
